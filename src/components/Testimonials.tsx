...
export const Testimonials: React.FC = () => {
  return (
    <section className="py-16 bg-slate-900 -mx-4 px-4 overflow-hidden">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-white mb-4">O que dizem os viajantes</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((t, idx) => (
            ...
            >
              ...
              <p className="text-slate-300 text-sm mb-4 italic">"{t.content}"</p>
              <div>
