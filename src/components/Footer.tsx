          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16">
            ...
            <div>
              ...
              <div className="flex gap-3">
                ...
                <SocialIcon href="https://viajescuscoperu.com/">
                  <Globe size={16} />
                </SocialIcon>
              </div>
            </div>
...
const SocialIcon = ({ href, children }: { href: string; children: React.ReactNode }) => (
  <a
    ...
    className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-brand-cyan hover:text-white transition-all"
  >
    {children}
  </a>
);
