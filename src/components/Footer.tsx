          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-wrap gap-4 items-center justify-center md:justify-start">
                ...
                {/* Sellos de Confianza (Garantía) */}
                <div className="flex items-center gap-4 pl-4 border-l border-white/10 ml-2">
                  <img 
                    src="https://www.tripadvisor.com.br/img/cdsi/img2/branding/v2/Tripadvisor_lockup_horizontal_secondary_registered-39400-2.svg" 
                    alt="TripAdvisor" 
                    className="h-4 md:h-5 w-auto brightness-0 invert" 
                  />
                  <img 
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Logotipo_Marca_Per%C3%BA.svg/1200px-Logotipo_Marca_Per%C3%BA.svg.png" 
                    alt="Marca Perú" 
                    className="h-6 md:h-8 w-auto brightness-0 invert" 
                  />
                  <div className="text-[10px] font-black leading-none text-white border border-white/40 p-1 rounded tracking-tighter">
                    MINCETUR
                  </div>
                </div>
              </div>
