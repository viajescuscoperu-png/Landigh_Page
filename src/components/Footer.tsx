          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-wrap gap-4 items-center justify-center md:justify-start">
                ...
                {/* Sellos de Confianza (Solo Logos Limpios) */}
                <div className="flex items-center gap-6 pl-6 border-l border-white/10 ml-2">
                  <img 
                    ...
                    alt="TripAdvisor" 
                    className="h-4 md:h-5 w-auto brightness-0 invert opacity-80 hover:opacity-100 transition-opacity" 
                  />
                  <img 
                    src="https://upload.wikimedia.org/wikipedia/commons/d/d4/Logotipo_Marca_Per%C3%BA.svg" 
                    alt="Marca Perú" 
                    className="h-6 md:h-8 w-auto brightness-0 invert opacity-80 hover:opacity-100 transition-opacity" 
                  />
                  <div className="text-[11px] font-black leading-none text-white/80 border border-white/30 px-2 py-1 rounded-md tracking-tighter hover:text-white hover:border-white transition-all">
                    MINCETUR
                  </div>
                </div>
              </div>
