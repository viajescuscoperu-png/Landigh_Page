...
parentWindow.fbq('init', '1535123857528514');
...
parentDoc.addEventListener('click', function(e) {{
    ...
    if (waBtn || webBtn) {{
        ...
        if (SB_URL && SB_KEY) {{
            ...
            if (isWa && typeof parentWindow.fbq === 'function') {{
                parentWindow.fbq('track', 'Lead', {{
    ...
    with st.container():
        ...
        st.markdown(f"""
            <div class="tour-content">
                ...
                <a href="{wa_link}" target="_blank" rel="noopener noreferrer" class="wa-btn js-wa-btn" data-tour="{tour_name_js}">
