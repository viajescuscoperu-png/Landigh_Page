...
--
-- NOTA: si ya tenías esta tabla creada de antes (sin las columnas
-- de "audience"/nacional-extranjero), usa en su lugar el script
-- setup_supabase_tours_audience.sql para migrarla sin perder tus
-- tours. Este script es solo para una base de datos nueva.
-- ============================================================
...
CREATE TABLE IF NOT EXISTS tours (
    ...
    audience            TEXT NOT NULL DEFAULT 'foreign' CHECK (audience IN ('national', 'foreign', 'both')),
    price_foreign       TEXT,                     -- precio actual para extranjeros, ej. "299 USD"
    old_price_foreign   TEXT,                     -- precio anterior (tachado) para extranjeros
    message_foreign     JSONB,                    -- {"pt":"...","es":"...","en":"..."} mensaje de WhatsApp
    price_national      TEXT,                     -- precio actual para nacionales, ej. "S/. 350"
    old_price_national  TEXT,                     -- precio anterior (tachado) para nacionales
    message_national    JSONB,                    -- {"pt":"...","es":"...","en":"..."} mensaje de WhatsApp
    sort_order          INTEGER NOT NULL DEFAULT 0,
    created_at          TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);

-- 2. Sembrado con los 5 tours que hoy están hardcodeados en el código,
--    para no perder nada al migrar a la base de datos. Todos parten
--    marcados como "foreign" (extranjero); agrega tarifa nacional
--    desde el panel /?admin=1 cuando la tengas lista.
INSERT INTO tours (id, name, image, includes, urgency, curiosity, is_gold, audience, price_foreign, old_price_foreign, message_foreign, sort_order)
VALUES
(
    'mp-premium', 'Machu Picchu Premium', '/mp-premium.jpg',
...
(
    'mp-express', 'Machu Picchu Express', '/machu.jpg',
...
(
    'humantay-vip', 'Humantay Lake', '/humantay.jpg',
...
(
    'rainbow-mountain', 'Rainbow Mountain', '/rainbow.jpg',
...
(
    'pallay-punchu', 'Pallay Punchu Intenso', '/pallay.jpg',
...
COMMENT ON TABLE tours IS 'Tours mostrados en la landing, editables desde el panel /?admin=1 (crear, editar, eliminar). audience controla si se muestran a nacionales, extranjeros o ambos.';
