...
function trackWhatsApp(tourName, waLink) {{
    ...
    // 3. Retraso mínimo crítico (200ms) para garantizar que la red despache nuestra data al DB
    setTimeout(() => {{
    ...
    with st.container():
        ...
        st.markdown(f"""
            <div class="tour-content">
                ...
                <a href="#" onclick="trackWhatsApp('{tour_name_js}', '{wa_link}'); return false;" class="wa-btn">
